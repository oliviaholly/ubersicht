        ...
        for (let item of cfg.displayOrder) {
            switch (item) {
                case "I":
                    ...
                    let clonedArtwork = React.cloneElement(artwork, {
                        key: index,
                    });
                ...
                case "A":
                    ...
                    let clonedArtist = React.cloneElement(artist, {
                        key: index,
                    });
                ...
                case "s":
                    ...
                    let clonedShuffle = React.cloneElement(shuffle, {
                        key: index,
                    });
                ...
                case "r":
                    ...
                    let clonedRepeat = React.cloneElement(repeat, {
                        key: index,
                    });
